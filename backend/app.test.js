...
// import getAll from '../client/src/services/notes.js'
// import App from '../client/src/App';

// // Mocking fetch requests
// beforeAll(() => {
//     const originalAdd = global.getAll; // save the original `add` function
//     global.getAll = jest.fn(() => []); 
//     // jest.spyOn(global, 'getAll').mockResolvedValue({
